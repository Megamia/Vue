  ...
  <div class="sidebar">
	...
	c3.86,0,7,3.141,7,7S52.86,56,49,56z"
      ...
      <span class="list">
        ...
        <router-link to="/AboutPage">Users</router-link>
      </span>
      <span class="list">
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        <router-link to="/HomePage">Documents</router-link>
      </span>
      <span class="list">
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        <router-link to="/AboutPage">Photos</router-link>
      </span>
      <span class="list">
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        <router-link to="/HomePage">Hierarchy</router-link>
      </span>
    </div>
    <div class="page page2">
      <span class="list">
        ...
        <router-link to="/AboutPage">Message</router-link>
      </span>
      <span class="list">
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        <router-link to="/HomePage">Help</router-link>
      </span>
      <span class="list">
